...
\begin{frame}{Recomendação prática de montagem}
  ...
  \begin{block}{Como remontar mosaicos sem costura}
    \small % Reduzir levemente a fonte do bloco ajuda a ganhar espaço vertical
    \begin{enumerate}
  ...
  \vfill % Empurra o conteúdo abaixo para o final do slide de forma equilibrada

  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering
      % Definimos uma altura máxima (ex: 3.5cm) e mantemos a proporção
      \includegraphics[height=3.5cm, width=\linewidth, keepaspectratio]{mosaic_none.png}\\[0.2em]
      {\scriptsize \texttt{none} --- costuras}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[height=3.5cm, width=\linewidth, keepaspectratio]{mosaic_gaussian.png}\\[0.2em]
      {\scriptsize \texttt{gaussian} --- sem costura}
    \end{column}
  \end{columns}
